...
<div class="hata-kutusu">
    ...
    <h2 class="hata-mesaj">{{ @$title }}</h2>
    <h3>Merhaba, {{ @$userName }}.<br>
        Sistemimizden talep etmiş olduğunuz, {{ @$title }} web sitesinin fiyatı, {{ date("d-m-Y") }} tarihi
        için {{ @$price }}₺'dir.<br>
        Fiyatlarımız ilerleyen tarihlerde değişkenlik gösterebilir.</h3>
